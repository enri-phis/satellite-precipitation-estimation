"""
Validazione finale delle classi di precipitazione contro il riferimento IMERG.

Questo modulo contiene il confronto finale tra le classi previste dal modello e il prodotto IMERG:
- aggregazione oraria delle predizioni SEVIRI;
- conversione delle classi in rate di precipitazione equivalenti;
- confronto sulla griglia IMERG;
- stima di metriche globali come accuracy, precision, recall, F1 e HSS.
"""
...
def classify_precip(precip, intervals=RAIN_INTERVALS_5C):
    """Classifica una mappa continua di precipitazione nelle cinque classi usate nel progetto."""
...
def run_validation(model_out_dir, processed_dir, imerg_input_dir):
    """Esegue il confronto finale tra predizioni SEVIRI e classi IMERG aggregate orariamente."""
    ...
    print("Risultati globali validazione:")
