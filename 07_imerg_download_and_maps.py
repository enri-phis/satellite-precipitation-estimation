...
# --- Configurazione: impostare i valori prima di eseguire ---
LINKS_FILE = "PATH/TO/links_imerg.txt"
DOWNLOAD_OUTPUT_DIR = "PATH/TO/imerg_hdf5_download"
WGET_PATH = "PATH/TO/wget.exe"

# Credenziali Earthdata: usare variabili di ambiente, non hardcodare nel file.
EARTHDATA_USERNAME = os.getenv("EARTHDATA_USERNAME", "")
EARTHDATA_PASSWORD = os.getenv("EARTHDATA_PASSWORD", "")

IMERG_INPUT_DIR = "PATH/TO/imerg_hdf5_input"
RAW_MAPS_OUTPUT_DIR = "PATH/TO/imerg_raw_maps"
HOURLY_CLASS_MAPS_OUTPUT_DIR = "PATH/TO/imerg_hourly_class_maps"

# Esecuzione sezioni (True/False)
RUN_DOWNLOAD = False
...
SAMPLE_HDF5_FILE = "PATH/TO/imerg_hdf5_input/example.HDF5"
# ------------------------------------------------------------
